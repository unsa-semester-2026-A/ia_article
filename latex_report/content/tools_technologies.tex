...
Model development and training were implemented in Python using \textbf{PyTorch}
...
on \textbf{Google Colaboratory} accelerated hardware (NVIDIA T4 and A100
...
Model architectures are drawn from the \textbf{Ultralytics YOLO} ecosystem~\cite{Jocher2026}, which provides YOLO11\allowbreak-OBB and YOLO26\allowbreak-OBB with built-in support
...
exported to the \textbf{ONNX} portable format, enabling CPU-only evaluation
