...
% \usepackage{flushend}          % Optional last-page column balancing.
\usepackage[colorlinks=true,linkcolor=blue,citecolor=blue,urlcolor=blue]{hyperref}
\Urlmuskip=0mu plus 2mu
\input{latex_report/style/style.tex}
...
\input{latex_report/content/frontmatter.tex}


%% main text
\input{latex_report/content/index.tex}
