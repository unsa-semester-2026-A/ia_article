...
> [!WARNING]
> **Propuesta histórica, parcialmente superada.** Este documento fue la propuesta inicial del
> estudio. La Fase 2 con IC-Light y las 6 condiciones de ablación que describe **ya no son el
> alcance vigente**: fueron reemplazadas por una comparativa entre tres familias de detectores
> orientados. El plan autoritativo vive en `plan/`, y el punto de entrada es `plan/00_overview.md`.
> Las secciones de Fase 0 (pseudo-labeling), Fase 1 (LaMa) y de la métrica siguen siendo válidas y
> son la referencia de implementación de esas etapas.
